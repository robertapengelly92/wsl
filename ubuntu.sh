...
apt -y install gettext git imagemagick qt5-style-plugins p7zip-full p7zip-rar pkg-config sqlite3 subversion texinfo webp xdg-utils xorriso || exit 1
...
apt -y install gdebi-core ghex python3 python3-pip || exit 1
